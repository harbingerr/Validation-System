...
################################################################################
## Form generated from reading UI file 'untitled2EVnced.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 776, 525))
...
"border-style: solid;")
        ...
        self.lb_icon = QLabel(self.header_frame)
        self.lb_icon.setObjectName(u"lb_icon")
        self.lb_icon.setPixmap(QPixmap(u"icons/icons8-dns-50.png"))

        self.gridLayout_2.addWidget(self.lb_icon, 0, 0, 2, 1)
