...
################################################################################
## Form generated from reading UI file 'untitledJNOmix.ui'
##
...
"padding: 15px 10px;")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 756, 0))
        self.scrollAreaWidgetContents_3.setMaximumSize(QSize(16777215, 0))
